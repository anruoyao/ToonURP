Shader "ToonURP/ToonEye"
{
    Properties
    {
        ...
        [KWEnum(FeatureMode, Parallax, _PARALLAX)] _EnumFeatureMode ("特性", float) = 0
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomFloat1 ("视差缩放", Range(0, 1)) = 1.0
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomFloat2 ("遮罩边缘", Range(0, 1)) = 0.8
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomFloat3 ("遮罩边缘偏移", Range(0, 1)) = 0.2
