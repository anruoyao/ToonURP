Shader "ToonURP/ToonWater"
{
    Properties
    {
        ...
        [Sub(FeatureMode)] _CustomFloat2 ("深度最大距离", Float) = 1
        [Sub(FeatureMode)] _CustomFloat3 ("深度渐变岸边", Float) = 0.2
        [Sub(FeatureMode)] _CustomFloat4 ("深度消失岸边", Float) = 50
        [Sub(FeatureMode)] _CustomFloat5 ("菲涅尔幂次", Range(0.1,20)) = 5
        [Sub(FeatureMode)] _CustomVector1 ("波浪速度", vector) = (1, 1, 1, 1)
        [Tex(FeatureMode)] _CustomMap2 ("法线扭曲贴图", 2D) = "white" {}
        [Sub(FeatureMode)] _CustomFloat6 ("法线缩放", Float) = 1
        [Sub(FeatureMode)] _CustomFloat7 ("法线强度", Float) = 1
        [Tex(FeatureMode)] _CustomCube1 ("天空盒贴图", Cube) = "_Skybox" {}
        [Sub(FeatureMode)] _CustomFloat8 ("水下扭曲", Range(0.01,1)) = 0.1
        [Sub(FeatureMode)] _CustomFloat9 ("焦散缩放", Range(1,50)) = 15
