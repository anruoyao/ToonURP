Shader "ToonURP/ToonStocking"
{
    Properties
    {
        ...
        [KWEnum(FeatureMode, FresnelStocking, _FRESNEL_STOCKING)] _EnumFeatureMode ("特性", float) = 0
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomFloat1 ("丝袜幂次", Float) = 0.5
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomVector1 ("内部颜色", Color) = (1,1,1,1)
        [Sub(FeatureMode)] [ShowIf(_EnumFeatureMode, Equal, 0)] _CustomVector2 ("外部颜色", Color) = (1,1,1,1)
