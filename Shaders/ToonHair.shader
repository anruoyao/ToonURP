Shader "ToonURP/ToonHair"
{
    Properties
    {
        ...
        [KWEnum(ShadingMode, CelShading, _CELLSHADING, PBRShading, _PBRSHADING, CelHair, _CUSTOMSHADING)] _EnumShadingMode ("模式", float) = 2
        ...
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NotEqual, 1)] _CellThreshold ("色块阈值", Range(0.01,1)) = 0.5
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NotEqual, 1)] _CellSmoothing ("色块平滑", Range(0.001,1)) = 0.001
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NotEqual, 1)] _SpecularIntensity ("高光强度", Range(0,8)) = 1
        ...
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NotEqual, 1)] _ScatterColor ("散射颜色", Color) = (1,1,1,1)
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NotEqual, 1)] _ScatterWeight ("散射权重", Range(4,20)) = 10
        [Tex(ShadingMode_CUSTOMSHADING)] _CustomMap1("噪点偏移贴图", 2D) = "white" {}
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomFloat1 ("高光偏移1", Range(0,5)) = 0.8
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomFloat2 ("高光偏移2", Range(0,5)) = 1.5
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomFloat3 ("高光光泽度1", Range(0,5)) = 0.5
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomFloat4 ("高光光泽度2", Range(0,5)) = 0.9
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomVector1 ("高光颜色1", Color) = (1,1,1,1)
        [Sub(ShadingMode_CUSTOMSHADING)] _CustomVector2 ("高光颜色2", Color) = (1,1,1,1)
